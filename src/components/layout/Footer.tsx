...
const socialLinks = [
  ...
  },
  {
    ...
    color: "hover:bg-black/5 hover:border-black/10",
    icon: (
      <Image 
    ...
    <footer className="relative bg-[#fafafa] border-t border-black/[0.06] overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-24 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="group w-10 h-10 rounded-full border border-black/10 flex items-center justify-center text-black/40 transition-all duration-300 hover:scale-115 hover:shadow-sm"
          ...
          >
            <h4 className="text-black font-semibold mb-6 text-sm uppercase tracking-wider font-sf-pro">
              Services
            </h4>
        ...
        <motion.div
          ...
          className="pt-8 border-t border-black/[0.06] flex flex-col md:flex-row justify-between items-center gap-4"
        >
          <p className="text-black/30 text-sm font-normal font-sf-pro">
