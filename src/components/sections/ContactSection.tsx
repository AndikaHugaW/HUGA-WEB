      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="mb-20 text-center">
          ...
          <motion.p
            ...
            className="text-black/30 text-lg mt-6 max-w-2xl mx-auto font-normal font-sf-pro"
          >
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            <div>
              ...
              <p className="text-black/30 leading-relaxed mb-8 font-normal font-sf-pro">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-black/[0.02] border border-black/[0.06] flex items-center justify-center shadow-sm relative overflow-hidden">
                  <Image 
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-black/70 mb-2 font-medium font-sf-pro">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-black/70 mb-2 font-medium font-sf-pro">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-black/70 mb-2 font-medium font-sf-pro">
                  Message
                </label>
                <textarea
                  id="message"
